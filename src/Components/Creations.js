...
const Creations = () => {
  return (
    <section id="creations" className="text-gray-600 body-font">
      <h2 className="text-center font-semibold w-3/4  mx-auto my-20 text-2xl">
      ...
      <p className="text-center text-2xl w-3/4 mx-auto sm:w-2/5">
