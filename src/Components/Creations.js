  ...
  return (
    <div id="creations" className="flex flex-col items-center justify-center">
      <h2 className="text-3xl mb-8 ">Parcours Création</h2>
        ...
        <div className="flex flex-col gap-x-8 lg:flex-row w-2/3 h-50 mb-12">
          {crea.map((item, index) => (
            <ul key={index}>
              <li className="flex p-4 mb-8 flex-col items-center justify-center h-full gap-y-4 rounded-lg shadow-lg bg-grey-s">
                <img
