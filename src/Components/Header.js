    ...
    return (
        <header className="bg-blue-s h-14 w-full shadow-md fixed top-0 left-0">
            <div className="md:flex items-center justify-between ">
                ...
                <ul className={`bg-blue-s pb-12 absolute text-center z-[-1] w-full left-0 transition-all duration-300 ease-in ${burger ? 'top-10 opacity-100' : 'top-[-490px]'} opacitiy-0 md:opacity-100 md:z-auto md:w-auto md:static md:flex md:items-center md:pb-0 md:pl-0`}>
                    {links.map((link) => (
