      ...
      <div class="container px-5 pb-24 mx-auto">
        ...
        <div class="flex flex-wrap -m-4 text-center">
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full z-[-20]" data-aos="zoom-in"
              data-aos-delay="50">
            <div class="border-2 border-gray-100 px-4 py-6 rounded-lg shadow-lg">
              <svg
                fill="none"
                stroke="currentColor"
              ...
              <CountUp duration={2} delay={1} end={100} />
                K
              </h2>
              <p class="leading-relaxed">Mots sur internet</p>
            </div>
          </div>
          <div
          ...
          >
            <div class="border-2 border-gray-100 px-4 py-6 rounded-lg shadow-lg">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900">+<CountUp duration={2} delay={1} end={40} /></h2>
          ...
          >
            <div class="border-2 border-gray-100 px-4 py-6 rounded-lg shadow-lg">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900"><CountUp duration={2} delay={1} end={100} /></h2>
